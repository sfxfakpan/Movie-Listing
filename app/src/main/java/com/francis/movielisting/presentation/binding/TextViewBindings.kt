...
import com.francis.movielisting.presentation.util.appendZeroBeforeNumber
...
fun TextView.bindMovieRuntime(dateString: String?) {
    ...
    val date = SimpleDateFormat(Api.getRuntimeDateFormat(), Locale.getDefault()).parse(dateString)
    val pat =
